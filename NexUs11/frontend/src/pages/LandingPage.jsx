...
export const LandingPage = ({ onStartResearch, onOpenAuth, onNavigate }) => {
  ...
  const visualPipeline = [
    { title: 'UPLOAD PAPERS', desc: '5–8 PDFs/DOCs ingested into session memory', icon: BookOpen },
    { title: 'EXTRACT EVIDENCE', desc: 'Granular OCR paragraph anchors with confidence audit', icon: ShieldCheck },
      ...
      <section className="max-w-5xl mx-auto space-y-12">
        <div className="text-center space-y-3 max-w-3xl mx-auto">
          ...
          <p className="text-sm sm:text-base text-[#64748B] leading-relaxed">
            Conventional tools summarize papers in isolation. NEXUS connects the evidence across papers to identify defensible research opportunities and construct actionable research strategies.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="nexus-hover-card p-6 space-y-3 bg-white">
            ...
            <p className="text-xs text-[#0F172A] leading-relaxed">
              NEXUS is an academic meta-synthesis platform that creates a combined multi-paper research brain from 5–8 scientific studies, evaluating methodology shifts, dataset variance, and empirical contradictions.
            </p>
          </div>
          ...
          <div className="nexus-hover-card p-6 space-y-3 bg-white">
            ...
            <p className="text-xs text-[#0F172A] leading-relaxed">
              Zero-hallucination evidence lineage: every generated gap, opportunity, and research question is traced backwards through author limitations and verbatim citations with verified confidence audits.
            </p>
          </div>
