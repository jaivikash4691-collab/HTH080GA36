...
export const PipelineHeroSlider = ({ onSlideAction }) => {
  ...
  const slides = [
    ...
    },
    {
      ...
      stepNumber: '02 / 05',
      category: 'CONNECT',
      heading: 'CONNECT EVIDENCE ACROSS PAPERS',
    ...
    },
    {
      ...
      explanation: 'Convert evidence gaps into testable research questions, hypotheses, experiment protocols, and publishable 12-month roadmaps.',
          ...
          {active.visualType === 'map' && (
            <div className="w-full max-w-sm nexus-hover-card p-5 space-y-3">
              <div className="flex items-center justify-between border-b border-[#E2E8F0] pb-2">
                ...
                <EvidenceStrengthBadge strength="EXPLICIT" size="xs" />
              </div>
          ...
          {active.visualType === 'evidence' && (
            <div className="w-full max-w-sm nexus-hover-card p-5 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <EvidenceStrengthBadge strength="SUPPORTED" size="xs" />
              </div>
          ...
          {active.visualType === 'contradiction' && (
            <div className="w-full max-w-sm nexus-hover-card p-5 space-y-3 border-t-4 border-t-[#E11D48]">
              <div className="flex items-center justify-between">
                ...
                <EvidenceStrengthBadge strength="CONFLICTING" size="xs" />
              </div>
          ...
          {active.visualType === 'gaps' && (
            <div className="w-full max-w-sm nexus-hover-card p-5 space-y-3 border-t-4 border-t-[#D97706]">
              <div className="flex items-center justify-between">
                ...
                <EvidenceStrengthBadge strength="STRONG EVIDENCE" size="xs" />
              </div>
              ...
              <div className="flex items-center justify-between pt-1 text-[11px] font-bold text-[#D97706]">
                <span>Evidence: P1 • P2 • P4 • P5</span>
