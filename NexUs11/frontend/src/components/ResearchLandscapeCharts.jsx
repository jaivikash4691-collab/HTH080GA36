...
export const ResearchLandscapeCharts = () => {
  const { papers, openEvidence, openPaperProfile } = useResearch();
            ...
            <div className="pt-3 border-t border-[#E2E8F0] flex gap-2">
              <button
                ...
                onClick={() => {
                  ...
                  openEvidence(`${p.code || 'P1'}-p${p.pages > 10 ? '8' : '4'}`);
                }}
                className="flex-1 py-2 px-3 rounded-lg bg-[#1E1B4B] text-white text-xs font-bold hover:bg-[#1E1B4B]/90 transition-all cursor-pointer text-center"
              >
                View Paper Evidence
              </button>
              <button
                ...
                className="py-2 px-3 rounded-lg border border-[#E2E8F0] text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-all cursor-pointer"
              >
                Profile
              </button>
            </div>
      ...
      <div className="glass-card p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-bold text-[#0F172A]">Chronological Research Timeline</h3>
              <p className="text-xs text-[#64748B]">Click any paper node to inspect extracted evidence and metrics</p>
            </div>
          </div>
