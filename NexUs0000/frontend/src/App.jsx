...
function NexusApp() {
  ...
  return (
    <div className="min-h-screen bg-[#FBF9F5] dark:bg-[#0B0F19] text-[#1E1B4B] dark:text-[#F8FAFC] flex flex-col font-sans selection:bg-[#1E1B4B] selection:text-white transition-colors duration-200">
