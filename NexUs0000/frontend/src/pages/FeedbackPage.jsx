      ...
      <form onSubmit={handleSubmit} className="glass-card p-6 sm:p-8 space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="e.g. The Contradiction Hunter and Idea Lineage made it easy to pinpoint scanner variance..."
            className="w-full p-3.5 rounded-xl border border-[#E2E8F0] dark:border-[#334155] text-xs font-medium text-[#1E1B4B] dark:text-[#F8FAFC] focus:outline-none focus:border-[#1E1B4B] dark:focus:border-[#2563EB] bg-[#FBF9F5] dark:bg-[#0F172A]"
          />
        </div>
