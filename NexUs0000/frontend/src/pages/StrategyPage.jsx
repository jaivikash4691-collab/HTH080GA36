      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-[#E2E8F0] pb-6">
        <div>
          ...
          <p className="text-xs text-[#64748B] dark:text-[#94A3B8] mt-0.5">
            Turn multi-paper findings and identified gaps into publishable research questions, experiments, and actionable grants.
          </p>
        </div>
                ...
                {(researchOpportunities || []).map((opp, idx) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-black uppercase tracking-wider text-[#2563EB] bg-blue-50 dark:bg-blue-950/40 px-2.5 py-0.5 rounded">
                        POSSIBLE RESEARCH OPPORTUNITY #{idx + 1}
                      </span>
                    </div>
