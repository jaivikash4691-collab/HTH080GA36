...
export const ComparisonPage = ({ onNavigate }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      {/* Tip Banner */}
      <div className="p-3.5 rounded-xl bg-[#F8FAFC] dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-[#334155] flex items-center justify-between text-xs text-[#64748B] dark:text-[#94A3B8]">
        <div className="flex items-center gap-2">
          <FileText className="w-4 h-4 text-[#1E1B4B] dark:text-[#38BDF8]" />
          <span>Tip: The first column is locked (sticky) for easy horizontal scrolling. <strong>Click any row</strong> to open its full paper profile with verbatim findings.</span>
        </div>
        <GlobalAIBadge type="RESEARCH_GRADE" size="sm" />
      </div>
